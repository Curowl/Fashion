...
@section('title', 'Crear Venta desde Cotización')
                            ...
                            <div class="form-row" >
                                <div class="col-lg-4" @if($ocultarCampos) hidden @endif>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" @if($ocultarCampos) hidden @endif required>
