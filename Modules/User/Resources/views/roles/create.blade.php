            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">Crear un Rol <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="select-all">Otrogar todos los permisos</label>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_month_overview">Resumen Mensual</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_adjustments">Vista</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_quotations">Vista</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="create_quotation_sales">Venta desde proforma</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card h-100 border-0 shadow">
                                       ...
                                       <!--    <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_expenses">Editar</label>
                                                    </div>
                                                </div> -->
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="delete_expenses">Cerrar</label>
                                                    </div>
                                                </div>
                                        <!--    <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="access_expense_categories">Categoría</label>
                                                    </div>
                                                </div> -->
                                            </div>
                                        </div>
