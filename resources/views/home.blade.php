                    ...
                    <div class="card border-0">
                        <div class="card-body p-0 d-flex align-items-center shadow-sm">
                            ...
                            <div>
                                ...
                                <div class="text-muted text-uppercase font-weight-bold small">Ventas</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4">
                      ...
                      <div class="col-lg-7">
                          <div class="card border-0 shadow-sm h-100">
                              <div class="card-header">
                                  Ventas e Inversiones de los Últimos 7 Días
                              </div>
                              <div class="card-body">
                ...
                @can('show_monthly_cashflow')
                    <div class="col-lg-5">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-header">
                                Resumen del mes {{ now()->format('m, Y') }} (Actual)
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header">
                            Flujo de Efectivo Mensual (Inversiones y Ventas Realizadas)
                        </div>
                        <div class="card-body">
